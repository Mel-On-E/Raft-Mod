...
function Pickaxe.client_onCreate( self )
...
--function Pickaxe.sv_n_toggleTumble( self )
--	local character = self.tool:getOwner().character
--	character:setTumbling( not character:isTumbling() )
--end

function Pickaxe.client_onEquippedUpdate( self, primaryState, secondaryState )
...
function Pickaxe.sv_updateBlocking( self, isBlocking )
